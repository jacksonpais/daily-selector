...
DailySelector.prototype = {
  ...
  initialize: function (options) {
    ...
    function _createCalendar(calendarContainer, options) {
      ...
      let primaryColor = options?.color?.primary === undefined ? dailySelector.primaryColor : options?.color?.primary;
      let secondaryColor = options?.color?.secondary === undefined ? dailySelector.secondaryColor : options?.color?.secondary;
