...
const ICON_NEXT =
  "<svg class='h-8 w-8 text-red-500'  width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z'/>  <polyline points='9 6 15 12 9 18' /></svg>";
const ICON_SEARCH = "<svg class='h-8 w-8 text-red-500' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z'/><circle cx='10' cy='10' r='7' /><line x1='21' y1='21' x2='15' y2='15' /></svg>"
const ICON_CANCEL = "<svg class='h-8 w-8 text-red-500'  width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'>  <path stroke='none' d='M0 0h24v24H0z'/>  <line x1='18' y1='6' x2='6' y2='18' />  <line x1='6' y1='6' x2='18' y2='18' /></svg>"
...
DailySelector.prototype = {
  initialize: function (options) {
    ...
    function _createCalendar(calendarContainer, options) {
      ...
      btnPreviousMonth.innerHTML = ICON_PREVIOUS;
      ...
      btnNextMonth.innerHTML = ICON_NEXT;
      ...
      btnSearch.addEventListener("click", function (event) {
        ...
        if (searchYearInput.classList.contains("hide")) {
          ...
          btnSearch.innerHTML = ICON_CANCEL;
        } else {
