...
DailySelector.prototype = {
  initialize: function (options) {
    ...
    function _createCalendar(calendarContainer, options) {
      ...
      // year calendar view
      let calendarYear = _createElement(ELEMENTS.DIV_ELEMENT, elementId);
      calendarYear.id = "calendar-past-years";
      calendarYear.classList.add("calendar-past-years");
      ...
      calendarYear.appendChild(calendarYearNavigation);
